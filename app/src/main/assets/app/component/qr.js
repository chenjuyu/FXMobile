...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.$refs.qr.scan(function (res) {
            _this.text = res.res;
            _this.toast(_this.text);
        });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('text', [_vm._v(_vm._s(_vm.text))]), _c('qr', {
    ref: "qr",
    staticStyle: {
      position: "absolute",
      top: "0",
